...
//  ReadHub
//
//  Created by Chinmay Bansal on 3/22/23.
//
        ...
        User.logout { [weak self] result in
            ...
            case .success:
                ...
                DispatchQueue.main.async {
                    ...
                    let storyboard = UIStoryboard(name: Constants.logOutNavigationControllerIdentifier, bundle: nil)
